...
<head>
    ...
    <title>Verifica tu código | Sistema de Consulta CURT</title>
    <!-- Bootstrap -->
...
<div class="container">
    <div class="form-container">
        <h3 class="mb-3 text-center"><i class="fas fa-key"></i> Verifica tu código</h3>
        <form method="POST" action="VerificarCodigoServlet" autocomplete="off">
            <input type="hidden" name="correo" value="${correo}" />
            <div class="mb-3">
                <label for="codigo" class="form-label">Código recibido</label>
                <input type="text" class="form-control" name="codigo" id="codigo" required maxlength="6" pattern="[0-9]{6}" placeholder="Ingresa el código de 6 dígitos">
            </div>
            <button type="submit" class="btn btn-success mt-2">Verificar</button>
            <div class="login-links mt-3">
                <a href="login.jsp"><i class="fa fa-arrow-left"></i> Volver al inicio</a>
            </div>
        </form>
    </div>
</div>
