...
%>
     ...
     <% String id_motgen = request.getParameter("idmotivo"); 
    ...
    <body background="img_codigo4a_roja.jpg"> 
        <%! String total_motgen ,  mot_gen; %>
        <%ConexionBD conexion = new ConexionBD();%>
        
       <% PreparedStatement pst25 =(PreparedStatement) conexion.conn.prepareStatement( "SELECT * FROM \"seguim_CURT\".motivos_gen WHERE id_motgen = '"+id_motgen+"'");
                conexion.rs =pst25.executeQuery(); 
                while(conexion.rs.next()) {
                total_motgen = conexion.rs.getString("total_motgen");
                mot_gen = conexion.rs.getString("mot_gen");
                } 
        %>
        
        <div id="cont_form_center">
            <span class="text-eliminar"> Actualizar registro</span> <span class="capa-eliminar"> </span> 
            
            <form action="ActualizaMotivosGenCurt" method="post" id="form-actualizar">
             ...
             <div id="div_fecha">Fecha: 
              <input type="text" id="fecha_llenado" name="fecha_llenado" value="<%out.print(fecha);%>" readonly style="border-width:0; background:none; font-weight: bold;" class="w15" >
                    ...
                    <input type="hidden" name="id_motgen" id="id_motgen" value="<%=id_motgen%>">
                    ...
                    <br>
                    <div id="col_text"><span class="text_act"> Total:</span></div>
                    <div id="col_inp"><input type="text" name="total_motgen" id="total_motgen" value="<%=total_motgen%>" class="w5"></div>
                    <br><br>
                    <div id="col_text"><span class="text_act">  Motivos:</span></div>
                    <div id="col_inp"><input type="text" name="mot_gen" id="mot_gen" value="<%=mot_gen%>" class="w20"></div>
