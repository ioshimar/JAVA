...
String privilegio ="";
    ...
    <head>
        ...
        <script>   
            function p12_carga_datp5(valor_recibido){
                ...
                $.post(url,param,function(listaIdent){   
                 ...
                 $("#nom_archdr").val(elementoP5.nom_archivo); //agregamos el nombre al input
                 $("#cant_regdr").val(elementoP5.total_reg); 
                });
            }
        </script>
       
        <script src="js/ajx_guarda_datEntP12.js" type="text/javascript"></script>
        <script src="js/actualiza_datEntP12.js" type="text/javascript"></script>
        <!--<script src="js/funCargadatEntP12.js" type="text/javascript"></script>-->
            ...
            function habilita12(){
                var chk_adr = document.getElementById("chk_adr");
                    if(chk_adr.checked){
                                 ...
                                 //   $('#div_dr').hide(700); 
                                    $('#div_dr').find('input, textarea, select').val(''); //resetamos el valor
                               }
                 var chk_aue = document.getElementById("chk_aue");
                    if(chk_aue.checked){
                                 ...
                                 //   $('#div_ue').hide(700); 
                                    $('#div_ue').find('input, textarea, select').val(''); //resetamos el valor
                               }               
    ...
    try{             
     ...
     %>  
        <div id="cont_formulario">
            <form id="curtp12" name="curtp12">
            <span class="TextTitulo subrayado">Datos de entrega de información a la Unidad del Estado </span><br><br>
            ...
            <input type="hidden" name="id_dae" id="id_dae" value="">
         
            <span class="Text_tit">Selecciona el tipo de entrega:</span><br>
        <div id="cont_center2"> 
            <div id="cont_left">
                <input type="radio" name="tipo_entrega" id="chk_adr" onclick="javascript:habilita12();" value="A Direccion Regional"> 
                <label for="chk_adr">Entrega a Dirección Regional </label>
            </div>
            <fieldset id="div_dr">
                <legend>A DR/CE</legend>
                <div id="col_text"> Fecha</div>
                <div id="col_inp"><input type="text" name="fecha_ent12" id="fecha_ent12" class="fecha w15" placeholder="dd/mm/aaaa"> </div>
                <br><br>
                
                <div id="col_text">Nombre del responsable en OC que entrega la información</div>
                <div id="col_inp"><input type="text" name="nom_resp_oc" id="nom_resp_oc" class="w50"></div>
                <br><br>
                
                <div id="col_text">Nombre del responsable en DR/CE que recibe la información</div>
                <div id="col_inp"><input type="text" name="resp_rec_dr" id="resp_rec_dr" class="w50"></div>
                <br><br>
                
                <div id="col_text">Nombre del archivo</div>
                <div id="col_inp">
                     <select name="id_archivo" id="id_archivo" class="w30" onchange="javascript:p12_carga_datp5(this.value)">
           ...
           <%
            ...
            %>  
                ...
                <input type="text" name="nom_archdr" id="nom_archdr" class="w20 read" readonly="readonly">
                <br><br>
                
                <div id="col_text">Cantidad de registros</div>
                <div id="col_inp"><input type="text" name="cant_regdr" id="cant_regdr" class="w15"></div>
            </fieldset>
           <br><br>
           
           <div id="cont_left">
               <input type="radio" name="tipo_entrega" id="chk_aue" onclick="javascript:habilita12();" value="A Unidad del Estado"> 
               <label for="chk_aue">Entrega a Unidad del Estado </label>
           </div>
           <fieldset id="div_ue">
               <legend>A UE</legend>
                <div id="col_text"> Fecha</div>
                <div id="col_inp"><input type="text" name="fecha_ent_ue" id="fecha_ent_ue" class="fecha w15" placeholder="dd/mm/aaaa"> </div>
                <br><br>
                
                <div id="col_text">Nombre del responsable en OC que entrega la información</div>
                <div id="col_inp"><input type="text" name="nom_resp_dr" id="nom_resp_dr" class="w50"></div>
                <br><br>
                
                <div id="col_text">Nombre del responsable en UE que recibe la información</div>
                <div id="col_inp"><input type="text" name="resp_reci_ue" id="resp_reci_ue" class="w50"></div>
                <br><br>
                             
                <div id="col_text">Nombre del archivo</div>
                <div id="col_inp"><input type="text" name="nom_arch_ue" id="nom_arch_ue" class="w20"></div>
                <br><br>
                
                <div id="col_text">Cantidad de registros</div>
                <div id="col_inp"><input type="text" name="cant_reg_ue" id="cant_reg_ue" class="w15"></div>
                  ...
                  <div id="btn_enviar">
                    ...
                    <input type="button" value="+ Guardar" id="guarda_reg" name="guarda_reg" onclick="javascript:proceso_guardaP12();">
                    <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP12();" class="bactualizar">
                 </div>
                 
            <div id="div_delete">
                <a class="boton_delete" href="javascript:postwith('elimina_registro.jsp',{ue:'<%=id_ue%>', tab:'datos_entrega'})">
