...
String privilegio ="";
    ...
    <head>
        ...
        <script src="js/ajx_guarda_contanciaP13.js" type="text/javascript"></script>
        <script src="js/actualiza_contanciaP13.js" type="text/javascript"></script>
        <script src="js/funCargaConsP13.js" type="text/javascript"></script>
    ...
    <header>
     ...
     %>  
        ...
        <div id="cont_formulario">
          <form id="curtp13" name="curtp13">    
            
            <span class="TextTitulo subrayado">Constancia de cobertura </span><br><br>
            <div id="cont_center"><span class="text_smal15"> <%=nombre_ue+ " ("+Nombre_mun2+", "+name_edo+")"%></span></div><br>
       <!--     <div id="slc_curt">
                Cargar Información desde:<br>
                <select name="ue_curtprod" id="ue_curtprod" class="w100" onchange="javascript:carga_datp13CURT(this.value)">
       ...
       conexionCURT.rs =pst1.executeQuery(); 
        ...
        <div id="cont_center2"> 
                ...
                <div id="col_text">Fecha de solicitud</div>
                <div id="col_inp"><input type="text" name="fech_soli" id="fech_soli" class="fecha w15" placeholder="dd/mm/aaaa"> </div>
                <br><br>
                
                <div id="col_text">Fecha de emisión</div>
                <div id="col_inp"><input type="text" name="fech_emi" id="fech_emi" class="fecha w15" placeholder="dd/mm/aaaa"> </div>
                <br><br>
                
                <div id="col_text">No. folio constancia</div>
                <div id="col_inp"><input type="text" name="folio" id="folio" class="w10"></div>
                <br><br>
                  ...
                  <div id="btn_enviar">
                    ...
                    <input type="button" value="+ Guardar" id="guarda_reg" name="guarda_reg" onclick="javascript:proceso_guardaP13();">
                     <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP13();" class="bactualizar">
                 </div>
            
            <div id="div_delete">
                <a class="boton_delete" href="javascript:postwith('elimina_registro.jsp',{ue:'<%=id_ue%>', tab:'constancia'})"> 
