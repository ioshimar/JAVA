...
<html>
    <head>
        ...
        <script>
            ...
            function EliminaCapa(){
                ...
                var r = confirm("¿Estás seguro que deseas ELIMINAR el archivo?, también se eliminarán los registros de cobertura (dentro de la misma), así como los registros de las demás tablas donde este archivo esté relacionado ");
               if (r == true) {
    ...
    <body> 
       ...
       <% PreparedStatement pst25 =(PreparedStatement) conexion.conn.prepareStatement( "SELECT * FROM \"seguim_CURT\".datos_entrega_fis WHERE id_entrega = '"+id_entrega+"'");
        ...
        <div id="cont_form_center">
            <span class="text-eliminar"> Eliminar carpeta</span> <span class="capa-eliminar"> <%=nombre_arch%> </span> 
            
                <form action="operacion_elimina_ent_fis.jsp" method="get" id="form-eliminar">
