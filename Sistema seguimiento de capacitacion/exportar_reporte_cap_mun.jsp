...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  try{       
    PreparedStatement pst5=(PreparedStatement)conexion.conn.prepareStatement("SELECT D.\"NOM_EDO\" as nom_ent, \"INSNOMBRECIUDADMPIO\" as municipio, \"INSNOMBRE\" as nom_ue, fecha_cap FROM \"seguim_CURT\".capacitacion O, \"seguim_CURT\".ufg_directori_ufg C, \"seguim_CURT\".cat_edo D WHERE C.\"Id\" = O.id_ue AND C.\"CVE_ENTIDAD\" = D.\"CVE_EDO\" AND C.\"AMBITO\" LIKE 'M%' AND O.fecha_cap between '"+f_inicio_cap_mun+"' and '"+f_fin_cap_mun+"' ORDER BY D.\"NOM_EDO\" ASC;"  ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
    ...
    XSSFCell celdaSubtitulo = FilaSubtitulo.createCell(1);
        celdaSubtitulo.setCellValue("Informe de las capacitaciones realizadas a las Unidades del Estado "+f_inicio_cap_mun+" al "+f_fin_cap_mun+"");
    ...
    if(conexion.rs.next()){//SI encontró algo imprimimos lso encabezados...
        ...
        celdaEntrega.setCellValue("CAPACITACIONES");
     ...
     fila8.setHeight((short)0x190);
        celdaDatIE.setCellValue("MUNICIPAL");
        ...
        celdaE10.setCellValue("FECHA DE CAPACITACIÓN");
   ...
   while(conexion.rs.next()){
     ...
     String[] datosP5 = {nom_ent,municipio,nom_ue,fecha_cap};
  ...
  try{       
    PreparedStatement pst6=(PreparedStatement)conexion.conn.prepareStatement("SELECT D.\"NOM_EDO\" as nom_ent, count(O.id_ue) as total FROM \"seguim_CURT\".capacitacion O, \"seguim_CURT\".ufg_directori_ufg C, \"seguim_CURT\".cat_edo D WHERE C.\"Id\" = O.id_ue AND C.\"CVE_ENTIDAD\" = D.\"CVE_EDO\" AND C.\"AMBITO\" LIKE 'M%' AND O.fecha_cap between '"+f_inicio_cap_mun+"' and '"+f_fin_cap_mun+"' GROUP BY D.\"NOM_EDO\" ORDER BY D.\"NOM_EDO\" ASC;"  ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
  ...
  XSSFRow filaX3 = hoja1.createRow((short)fv2);
   ...
   //Creo la celda A0
    XSSFCell CeldaA0 = fila.createCell(0);
        ...
        String nombre="reporte capacitaciones municipales.xlsx";
