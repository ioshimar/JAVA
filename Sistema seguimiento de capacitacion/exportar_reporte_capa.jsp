...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    %>
        ...
        XSSFSheet hoja1 = objLibro.createSheet("Informe de capacitaciones");// Creo la hoja
  ...
  try{       
    PreparedStatement pst5=(PreparedStatement)conexion.conn.prepareStatement("SELECT T2.\"CVE_ENTIDAD\",T3.\"NOM_EDO\",COUNT(DISTINCT T1.fecha_cap) AS num_cap FROM seguimiento_cap.capacitacion AS T1, seguimiento_cap.ufg_directori_ufg as T2, seguimiento_cap.cat_edo as T3 "
                    + "WHERE T2.\"Id\"  =  T1.id_ue AND T2.\"CVE_ENTIDAD\"  =  T3.\"CVE_EDO\" GROUP BY T3.\"NOM_EDO\", T2.\"CVE_ENTIDAD\""  ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
    ...
    */    
     ...
     fila8.setHeight((short)0x190);
        celdaDatIE.setCellValue("CAPACITACIONES");
        ...
        celdaC10.setCellValue("NUMERO DE CAPACITACIONES");
   ...
   while(conexion.rs.next()){
       ...
       nom_ent= conexion.rs.getString("NOM_EDO");
        ...
        municipio= conexion.rs.getString("num_cap");
         if(municipio==null ){municipio="";}  
         
        
  
     String[] datosP5 = {nom_ent,municipio};
   ...
   //Creo la celda A0
    XSSFCell CeldaA0 = fila.createCell(0);
        ...
        String nombre="reporte de numero de capacitaciones por entidad.xlsx";
