...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  try{       
    PreparedStatement pst5=(PreparedStatement)conexion.conn.prepareStatement("SELECT nom_ent, \"INSNOMBRECIUDADMPIO\" as municipio, nom_ue, acepto FROM \"seguim_CURT\".concertacion O, \"seguim_CURT\".ufg_directori_ufg C WHERE C.\"Id\" = O.id_ue AND ((O.fec_pri_res between '"+f_inicio_ue2+"' and '"+f_fin_ue2+"') OR (O.fec_seg_res between '"+f_inicio_ue2+"' and '"+f_fin_ue2+"') OR (O.fec_ter_res between '"+f_inicio_ue2+"' and '"+f_fin_ue2+"')) ORDER BY O.nom_ent ASC;"  ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
    ...
    XSSFCell celdaSubtitulo = FilaSubtitulo.createCell(1);
        celdaSubtitulo.setCellValue("Informe de las respuestas recibidas por parte de las Unidad del Estado del "+f_inicio_ue2+" al "+f_fin_ue2+"");
    ...
    if(conexion.rs.next()){//SI encontró algo imprimimos lso encabezados...
        ...
        celdaEntrega.setCellValue("RESPUESTAS RECIBIDAS");
     ...
     fila8.setHeight((short)0x190);
        celdaDatIE.setCellValue("POR LAS UNIDADES DEL ESTADO");
   ...
   while(conexion.rs.next()){
     ...
     String[] datosP5 = {nom_ent,municipio,nom_ue,acepto};
  ...
  try{       
    PreparedStatement pst6=(PreparedStatement)conexion.conn.prepareStatement("SELECT nom_ent, count(nom_ue) as total FROM \"seguim_CURT\".concertacion O, \"seguim_CURT\".ufg_directori_ufg C WHERE C.\"Id\" = O.id_ue AND ((O.fec_pri_res between '"+f_inicio_ue2+"' and '"+f_fin_ue2+"') OR (O.fec_seg_res between '"+f_inicio_ue2+"' and '"+f_fin_ue2+"') OR (O.fec_ter_res between '"+f_inicio_ue2+"' and '"+f_fin_ue2+"')) GROUP BY nom_ent ORDER BY O.nom_ent ASC;"  ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
  ...
  XSSFRow filaX3 = hoja1.createRow((short)fv2);
   ...
   //Creo la celda A0
    XSSFCell CeldaA0 = fila.createCell(0);
        ...
        String nombre="reporte respuestas recibidas.xlsx";
