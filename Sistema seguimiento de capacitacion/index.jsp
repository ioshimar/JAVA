...
<html>
    <head>
        ...
        <script src="js/ajax_log_1.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    ...
    <body background="images/b7.jpg"  style="background-size: cover;"> <!---->
         ...
         <div id="contenedor-login">
             ...
             <h4 class="teclear">Iniciar sesión2</h4><br>
       <form id="form_sesion">
           <!-- <div id="c1"><span>Estado:</span> </div>-->
            
            <div id="c2">
               
                <img src="images/us.png" id="imag_es"/><input type="text" name="estado" id="estado" placeholder="Usuario" onkeypress="removeClass(this.id);" onkeyup=""  >
            </div>
           ...
           <div id="c2">
               <div class="div_relative">
                   <img src="images/lock.png" id="imag_es" alt=""/><input type="password" name="pwd" id="pwd" placeholder="********" onkeypress="removeClass(this.id);" onkeyup=""  >
          ...
          <div id="boton">
              <input type="button" value="Ingresar" id="enviar" onclick="javascript:ajax_sesion1();"> <!-- boton de envio de formulario, llama a funcion valida-->
          </div>
