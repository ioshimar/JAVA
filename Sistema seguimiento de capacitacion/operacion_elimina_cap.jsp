<%-- 
    Document   : operacion_elimina_cap
    Created on : 11/09/2019, 02:57:27 PM
...
<html>
    ...
    <body>
         ...
         static String nom_capa, num_elem, id_cap, nom_capa_A, num_elem_A,id_ue;
         %>
         <%
         ConexionBD conexion=new ConexionBD(); 
    
            id_cap = request.getParameter("id_cap");
            id_ue = request.getParameter("id_ue");
 
       conexion.stmt=conexion.conn.createStatement();      
       conexion.stmt.executeUpdate( "DELETE FROM seguimiento_cap.capacitacion where id_cap='"+id_cap+"' and id_ue='"+id_ue+"' ");
