...
<html>
    ...
    <body>
         ...
         static String  id_dae, id_ue;
         %>
         <%
         ConexionBD conexion=new ConexionBD(); 
    
            id_dae = request.getParameter("id_dae");
            id_ue = request.getParameter("id_ue");
 
       conexion.stmt=conexion.conn.createStatement();      
       conexion.stmt.executeUpdate( "DELETE  FROM \"seguim_CURT\".datos_entrega_p12 where id_dae='"+id_dae+"' and id_ue='"+id_ue+"' ");
  ...
  <script>
	alert('Registro eliminado correctamente'); 
         location.href = "curt_p12.jsp?ue="+<%=id_ue%>;
</script>
