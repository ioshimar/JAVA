...
<html>
    ...
    <body>
         ...
         static String  id_devolucion, id_ue;
         %>
         <%
         ConexionBD conexion=new ConexionBD(); 
    
            id_devolucion = request.getParameter("id_devolucion");
            id_ue = request.getParameter("id_ue");
 
       conexion.stmt=conexion.conn.createStatement();      
       conexion.stmt.executeUpdate( "DELETE FROM \"seguim_CURT\".devolucion where id_dev='"+id_devolucion+"' and id_ue='"+id_ue+"' ");
  ...
  <script>
	alert('Registro eliminado correctamente'); 
         location.href = "curt_p7.jsp?ue="+<%=id_ue%>;
</script>
