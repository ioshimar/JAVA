 ...
 */
public class ActualizaCurtP1 extends HttpServlet {
     ...
     String concerta  =  request.getParameter("concerta");  //checkbox 
       ...
       String usuario_resp  =  request.getParameter("usuario_resp"); 
        ...
        conexion.stmt.executeUpdate("SET DATESTYLE TO dmy; UPDATE \"seguim_CURT\".concertacion\n" +
                              ...
                              + " nombre_destin1='"+nom_destinatario+"', nombre_remi1='"+nom_remitente+"', nombre_destin2='"+nom_destinatario2+"', nombre_remi2='"+nom_remitente2+"', nombre_destin3='"+nom_destinatario3+"',"
                              + " nombre_remi3='"+nom_remitente3+"', observaciones='"+observaciones+"' , activa_2of ='"+activa_2doOf+"', activa_3of ='"+activa_3erOf+"', concerta ='"+concerta+"', usuario_resp='"+usuario_resp+"' "
                              + "  WHERE id_ue = '"+id_ue+"'");
