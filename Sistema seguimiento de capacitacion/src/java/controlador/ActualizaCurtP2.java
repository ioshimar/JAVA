       ...
       ConexionBD conexion= new ConexionBD(); 
        ...
        if(norma_cat==null){
         ...
         try {
                         ...
                         conexion.stmt.executeUpdate("SET DATESTYLE TO dmy; UPDATE seguimiento_cap.capacitacion\n" +
                                                "SET nom_user='"+nom_user+"', norma_cat='"+norma_cat+"', norma_curt='"+norma_curt+"', lineamiento='"+lineamiento+"', diccionario='"+diccionario+"', fecha_cap='"+fecha_impart+"', lugar='"+lugar+"', resp_inegi='"+responsable+"', cant_pers='"+cantidad_p+"', "
