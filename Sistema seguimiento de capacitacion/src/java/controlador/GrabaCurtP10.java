...
"    VALUES (nextval('\"seguim_CURT\".id_gencurt'), '"+id_ue+"', '"+nom_respgen+"', '"+fech_ini10+"', '"+fech_ter10+"', '"+con_curt+"', '"+sin_curt+"', \n" +
"            '"+fecha_llenado+"', '"+id_archivo+"', '"+nom_archivo+"', '"+usuario_resp+"', '"+cve_edo+"')");
