 ...
 */
public class GrabaCurtP9 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        conexion.stmt.executeUpdate("SET DATESTYLE TO dmy; INSERT INTO \"seguim_CURT\".entrega_ssg(\n" +
                "            id_essg, id_ue, fecha, nom_resp_ent, nom_resp_rec, fecha_llenado)\n" +
                "    VALUES (nextval('\"seguim_CURT\".id_ent_ssg'), '"+id_ue+"', '"+fech_entssg+"', '"+resp_entssg+"', '"+resp_recssg+"', '"+fecha_llenado+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GrabaCurtP9.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
