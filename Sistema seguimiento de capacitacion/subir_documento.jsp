...
<html>
    <head>
        ...
        <script src="js/ajx_proceso_uploadFile.js" type="text/javascript"></script>
...
%>
    ...
    <body background="img_codigo4a_roja.jpg"> 
        ...
        <div id="cont_form_center">
            <span class="text-eliminar"> Subir Documento del <%=tipo_oficio%></span> <span class="capa-eliminar"> </span> 
            <form id="form_upload" > <!-- action="SubirArchivo" enctype="MULTIPART/FORM-DATA" method="post"-->
                <input type="hidden" name="id_ue" id="id_ue" value="<%=id_ue%>">
                <input type="hidden" name="colum" id="colum" value="<%=colum%>">
                <br><br>

                <input type="file" name="archivos" id="arch1" class="w50"  /><br/><br><br>

                <div id="boton">
                    <input type="button" onclick="javascript:Cancelar();" value="&ll; Regresar" class="bcancelar" style="max-width: 100px;"/> &nbsp; &nbsp; &nbsp; &nbsp;    
                    <input type="button" value="Enviar" onclick="proceso_uploadFile();" />
                </div>
            </form>
        </div>
