...
<html>
    ...
    <head>
        ...
        <script src="js/ajax_psw_admin.js" type="text/javascript"></script>
...
<script src="js/ajx_alta_admin.js" type="text/javascript"></script>
  ...
  <div id="cont_formulario" style="max-width: 800px;">
    <div id="cont_center">    
     <span class="TextTitulo subrayado">Registrar Usuario</span><br><br> <br> 
     
             <form name="formu_usuario" id="formu_usuario">
               
                        
                 <div id="col_textCenter_2">  <span class="lbl_psw">Nombre completo</span></div>
                 <div id="col_inpCenter_2">  <input type="text" name="nombre" id="nombre" class="w30"></div>
              
                      <br><br>
                   
                 <div id="col_textCenter_2">  <span class="lbl_psw">Nombre usuario</span> </div>
                 <div id="col_inpCenter_2">  <input type="text" name="nom_usuario" id="nom_usuario" class="w30" placeholder="nombre.usuario"></div>
                ...
                <div id="col_inpCenter_2"> <input type="password" name="psw" id="psw" class="w30"></div>
                      ...
                      <br> <br>
                 <div id="col_textCenter_2">  <span class="lbl_psw">Permisos</span></div>
                 <div id="col_inpCenter_2">
                     <input type="radio" name="permisos" id="permiso_todo" value="todo"> <label for="permiso_todo" class="Gotham-Book"> Lectura y escritura</label><br><br>
                     <input type="radio" name="permisos" id="permiso_lectura" value="lectura" > <label for="permiso_lectura" class="Gotham-Book"> Lectura</label>
                 </div>
                 <br><br><br>
                      
                      <input type="button"  value="Aceptar" onclick="javascript:proceso_guarda_admin();">
