...
<script src="../js/cerrar_notif.js" type="text/javascript"></script>
  ...
  <div id="cont_formulario" style="max-width: 500px;">
    <div id="cont_center">    
     <span class="TextTitulo subrayado">Cambiar Contraseña</span><br><br> <br> 
     
             <form name="formu_pass" id="formu_pass">
                <input type="hidden" name="usuario" id="usuario" value="<%=session_admin_curt%>">
                   <div class="relative">        
                    ...
                    <div class="relative">    
                      ...
                      <input type="button"  value="Aceptar" onclick="javascript:ajax_psw_adm();">
