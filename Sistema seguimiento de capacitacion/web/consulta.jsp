...
"  FROM \"seguim_CURT\".devolucion WHERE id_ue = '"+idue+"'"  ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
 ...
 <!-- <table style="max-width: 600px; margin: 0 auto;">-->
  <%
   ...
   <!-------------------- Opción 2 con Tablas -------------------------------------------
   <tr>
   <th colspan="2" style="font-size: 14px;"><span class="Gotham-Book">Tipo de Asesoría</span></th>
     </tr>
     <tr>
         <td width="30%"> <span class="Gotham-Book">Registro de la Unidad del Estado</span></td>
         <td width="10%" style="text-align: center;"><span class="CarroisGR">< %out.print(T_regUE);%></span></td>
     </tr>
      <tr>
          <td><span class="Gotham-Book"> Uso y manejo del aplicativo</span></td>
          <td style="text-align: center;"><span class="CarroisGR">< %out.print(T_uso);%></span></td>
     </tr>
     <tr>
          <td><span class="Gotham-Book"> Estructuración de la información</span></td>
          <td style="text-align: center;"><span class="CarroisGR">< %out.print(T_estructura);%></span></td>
     </tr>
      <tr>
          <td><span class="Gotham-Book"> Convertir coordenadas cartesianas a geográficas</span></td>
          <td style="text-align: center;"><span class="CarroisGR">< %out.print(T_coord);%></span></td>
     </tr>
      <tr>
          <td><span class="Gotham-Book">Convertir información de un sistema de referencia geodésico a otro</span></td>
          <td style="text-align: center;"><span class="CarroisGR">< %out.print(T_infoS);%></span></td>
     </tr>
      <tr>
          <td><span class="Gotham-Book">Interpretación de los resultados de generación/actualización de la CURT</span></td>
          <td style="text-align: center;"><span class="CarroisGR">< %out.print(T_interp);%></span></td>
     </tr>-->
     <%
...
"  FROM \"seguim_CURT\".generacion_curt WHERE id_ue = '"+idue+"' ORDER BY id_gen" ,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE); 
 ...
 if(conexion.rs.next()){
  ...
  <tr>
        ...
        <td style="text-align: center; color: #0a5e51;">Motivos</td>
...
<%
 ...
 <%     
   ...
   %>          
             <tr>
                 <td><span class="CarroisGR"> <%=tipo_entrega12%> </span></td>
                 <td><span class="CarroisGR"> <%=fec_dr%> </span></td>
                 <td><span class="CarroisGR"> <%=arch_dr%> </span></td>
                 <td><span class="CarroisGR"> <%=cant_dr%> </span></td>
                 <td><span class="CarroisGR"> <%=nom_resp_ocent%> </span></td>
                 <td><span class="CarroisGR"><%=nom_resp_drec%> </span></td>        
             </tr>
   <%            
   ...
   %>      
            <tr>
                <td> <span class="CarroisGR"><%=tipo_entrega12%> </span></td>
                <td> <span class="CarroisGR"><%=fec_ue%> </span></td>
                <td> <span class="CarroisGR"><%=arch_ue%> </span></td>
                <td> <span class="CarroisGR"><%=cant_ue%> </span></td>
                <td> <span class="CarroisGR"><%=nom_resp_drent%> </span></td>
                <td> <span class="CarroisGR"><%=nom_resp_uerec%> </span></td>        
             </tr>
 <%             
         }
 %>
