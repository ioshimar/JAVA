...
String privilegio ="";
    ...
    <head>
        ...
        <script src="header_menu/jquery-latest.min.js" type="text/javascript"></script>
         ...
         <script src="js/Addinput2.js" type="text/javascript"></script>
         ...
         <script>
            function carga_datp5_11(valor_recibido) {
                       ...
                       $.post(url,param,function(listaIdent){   
                         ...
                         $("#nom_respue").val(elementoP5.nom_resp_ent);
                         $("#nom_archivo").val(elementoP5.nom_archivo); //agregamos el nombre al input
                       });
                   }    
         </script>
...
<script src="js/ajx_agrega_actcurtP11.js" type="text/javascript"></script>
<script src="js/actualiza_ActcurtP11.js" type="text/javascript"></script>
     ...
     $(document).ready(function() {
          ...
          <script>
            function CargaInput(valor){
                $("#total_motivo_a").val(valor); //cargamos en este input, el mismo valor que escribimos en Total de motivos
    ...
    try{             
     ...
     %>  
        <div id="cont_formulario">
         <form id="curtp11" name="curtp11">
            <span class="TextTitulo subrayado">Actualización de la CURT</span><br><br>
          ...
          <% String fecha=getFechaActual();%>
            ...
            <input type="hidden" name="id_actcurt" id="id_actcurt" value="" > <!-- le agregaremos valor hasta que le demos en el botón editar o Actualizar-->
        <div id="cont_center2">
             <div id="col_text">Selecciona el archivo</div>
            <div id="col_inp">
                <select name="id_archivo" id="id_archivo" class="w30" onchange="javascript:carga_datp5_11(this.value)">
         ...
         try{        
            ...
            <div id="col_text">Nombre del responsable de la Unidad del Estado</div>
            <div id="col_inp"><input type="text" name="nom_respue" id="nom_respue" class="w50 read" readonly="readonly"></div>
            <br><br>
            
            <fieldset>
                <legend>Fecha y hora de procesamiento (dd/mm/aa)</legend>
                <div id="col_text"><!-- --></div>
                <div id="col_inp"> 
                    <div id="cont1">  Inicio <br><input type="text" name="fech_ini11" id="fech_ini11" class="fecha w15" placeholder="dd/mm/aaaa"></div>
                    <div id="cont2">  Término<br><input type="text" name="fech_ter11" id="fech_ter11" class="fecha w15" placeholder="dd/mm/aaaa"> </div>
                </div>
            </fieldset>
            <br><br>
            ...
            <fieldset>
                ...
                <div id="col_text"></div>
                <div id="col_inp">
                    <div id="cont1"> Predios con CURT<br> <input type="text" name="con_curt11" id="con_curt11" class="w15"></div>
                    <div id="cont2"> Predios sin CURT <br> <input type="text" name="sin_curt11" id="sin_curt11" class="w15" onkeyup="javascript:CargaInput(this.value);"></div>
                </div>
               <br><br><br>
                ...
                <fieldset>
                    <legend>Motivos por lo que no se actualizó la CURT</legend>
                      <table class="table table-bordered" id="dynamic_field3" style="max-width:600px; margin: 0 auto;"> 
                   <tr> 
                       <th width="30%" style="text-align: center;">Total</th>
                       <th width="45%" style="text-align: center;">Motivo(s)</th>
                    </tr>
                   <tr>
                       <td><input type="text" name="total_motivo_a" id="total_motivo_a" class="w10" placeholder="Total"></td> 
                       <td><input type="text" name="motivo_a" id="motivo_a" class="w30" placeholder="Motivo(s)"></td> 
                      
                   <!--    <td width="15%"><button type="button" name="add3" id="add3" class="btn btn-success">Agregar <br> renglones</button></td>-->
                   </tr>
                  ...
                  <div id="btn_enviar">
                      <input type="button" value="Limpiar formulario" name="nuevo_reg" id="nuevo_reg" onclick="javascript:ResetForm11();" class="bLimpiaFrom" >&nbsp; &nbsp; &nbsp; &nbsp;
                    <input type="button" value="+ Agregar registro" name="agrega_reg" id="agrega_reg" onclick="agrega_actcurtP11();">&nbsp;
                     <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP11();" class="bactualizar">
                 </div>
            <br>
             <div id="btn_enviar">
