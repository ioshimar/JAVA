        ...
        <script>   
            function p12_carga_datp5(valor_recibido){
                ...
                $.post(url,param,function(listaIdent){   
                 ...
                 $("#nom_arch").val(elementoP5.nom_archivo); //agregamos el nombre al input
                 $("#cant_reg").val(elementoP5.total_reg); 
                });
            }
        </script>
    ...
    try{             
     ...
     %>  
        <div id="cont_formulario">
            ...
            <input type="hidden" name="id_dae" id="id_dae" value=""> <!-- aqui mandaremos el id_dae al dar clic en el botón de editar-->
        ...
        <div id="cont_center2"> 
            <div style="display: none;">   
                <span class="Text_tit">Selecciona el tipo de entrega:</span><br>
                    ...
                    <div id="cont_left">
                        <input type="radio" name="tipo_entrega" id="chk_aue" onclick="javascript:habilita12();" value="A Unidad del Estado" checked="checked"> 
                ...
                <div id="col_inp"><input type="text" name="fecha_ent" id="fecha_ent" class="fecha w15" placeholder="dd/mm/aaaa"> </div>
                <br><br>
                
                <div id="col_text">Nombre del responsable del INEGI que entrega la información</div>
                <div id="col_inp"><input type="text" name="nom_resp_ent" id="nom_resp_ent" class="w50"></div>
                <br><br>
                
                <div id="col_text">Nombre del responsable  que recibe la información</div>
                <div id="col_inp"><input type="text" name="resp_rec" id="resp_rec" class="w50"></div>
                <br><br>
           ...
           <%
            ...
            %>  
                ...
                <div id="col_inp"><input type="hidden" name="nom_arch" id="nom_arch" class="w20 read" readonly="readonly"></div>
                <br>
                
                <div id="col_text">Cantidad de registros</div>
                <div id="col_inp"><input type="text" name="cant_reg" id="cant_reg" class="w15 read" readonly="readonly"></div>
                  ...
                  <div id="btn_enviar">
                    <input type="button" value="Limpiar formulario" name="nuevo_reg" id="nuevo_reg" onclick="javascript:ResetForm12();" class="bLimpiaFrom" >&nbsp; &nbsp; &nbsp; &nbsp;
