...
<html>
    ...
    <head>
        ...
        <script src="header_menu/jquery-latest.min.js" type="text/javascript"></script>
          ...
          <script src="js/ajx_guarda_reg_ueP3.js" type="text/javascript"></script>
          <script src="js/actualiza_reg_ueP3.js" type="text/javascript"></script>
          <script src="js/funCargaRegueP3.js" type="text/javascript"></script>
    ...
    <header>
     ...
     %>  
        <div id="cont_formulario">
         ...
         <form id="curtp3" name="curtp3">
            <span class="TextTitulo subrayado">Registro de la Unidad del Estado</span><br><br>
            ...
            <fieldset>  
             <legend>Fechas de: </legend>
                <div id="col_textCenter">Solicitud de registro</div>
                <div id="col_inpCenter"><input type="text" id="sol_registro" name="sol_registro" placeholder="dd/mm/aaaa" class="fecha w15"> </div>
                
             <br><br>
                 <div id="col_textCenter">Envío de los documentos</div>
                 <div id="col_inpCenter"><input type="text" id="envio_doc" name="envio_doc" placeholder="dd/mm/aaaa" class="fecha w15"> </div>
                 
                     
             <br><br>
                 <div id="col_textCenter">Validación de los  documentos y envío de la firma electrónica</div>
                 <div id="col_inpCenter"><input type="text" id="val_doc" name="val_doc" placeholder="dd/mm/aaaa" class="fecha w15"> </div>
                 
            
                <!-- <div id="col_textCenter">Envío de la firma electrónica</div>-->
                <!-- <div id="col_inpCenter"> </div>  -->   
                <!--Solo lo mando como oculto para no tener que modificar otra vez en el códgo de guardar -->
                <input type="hidden" id="fec_firma" name="fec_firma" placeholder="dd/mm/aaaa" class="w15">
                 
             <br><br>
                 <div id="col_textCenter">Registro de usuarios responsables</div>
                 <div id="col_inpCenter"><input type="text" id="fec_usu" name="fec_usu" placeholder="dd/mm/aaaa" class="fecha w15"> </div>  
                 
             <br><br>
                 <div id="col_textCenter">Recepción de documentos originales</div>
                 <div id="col_inpCenter"><input type="text" id="fec_rece" name="fec_rece" placeholder="dd/mm/aaaa" class="fecha w15"> </div>            
            ...
            <br><br>
                  ...
                  <div id="btn_enviar">
                    ...
                    <input type="button" value="+ Guardar" id="guarda_reg" name="guarda_reg" onclick="javascript:proceso_guardaP3();">
                    <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP3();" class="bactualizar">
                 </div>
            
            <div id="div_delete">
              <a class="boton_delete" href="javascript:postwith('elimina_registro.jsp',{ue:'<%=id_ue%>', tab:'registro_ue'})"> 
