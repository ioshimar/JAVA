...
String privilegio ="";
    ...
    <head>
        ...
        <script>
            function habilita(){
                var f_shapeSi = document.getElementById("f_shapeSi");
                var f_shapeNo = document.getElementById("f_shapeNo");
                
                if(f_shapeNo.checked){
                    $('input[name="extension"], input[name="estruc"], input[name="atrib"], input[name="coord_geo"], input[name="total_reg"]').attr("disabled",true); //deshabilito radiobuttons
                    $('input[name="extension"], input[name="estruc"], input[name="atrib"], input[name="coord_geo"], input[name="total_reg"]').removeAttr('checked');
                    
                }else if(f_shapeSi.checked){
                     $('input[name="extension"], input[name="estruc"], input[name="atrib"], input[name="coord_geo"], input[name="total_reg"]').attr("disabled",false);
                }
        ...
        <script src="js/ajx_guarda_criteriosP6.js" type="text/javascript"></script>
        <script src="js/actualiza_criteriosP6.js" type="text/javascript"></script>
       <!-- <script src="js/funCargaCriterP6.js" type="text/javascript"></script>-->
    ...
    try{            
     ...
     %>  
        ...
        <div id="cont_formulario">
            <form id="curtp6" name="curtp6">  
            <span class="TextTitulo subrayado">Criterios de validación previos a la generación de la CURT</span><br><br>
         ...
         <% String fecha=getFechaActual();%>
             <div id="div_fecha">Fecha: 
              ...
              <input type="hidden" name="usuario_resp" id="usuario_resp" value="<%=sesion_cve_enc%>" class="w5" readonly="">
                ...
                <input type="hidden" name="id_validacion" id="id_validacion" value="" > <!-- le agregaremos valor hasta que le demos en el botón editar o Actualizar-->
             
            <div id="col_textCenter">Selecciona el archivo</div>
            <div id="col_inpCenter">
         ...
         <% } 
              ...
              <!--<div id="col_textCenter">Archivo seleccionado:</div>-->
              <!-- nada mas para que carge el nombre del archivo-->
              <div id="col_inpCenter"><input type="hidden" name="nom_archivo" id="nom_archivo" class="w15 read" readonly="readonly"></div><br> 
             
             
             
             
            <input type="hidden" name="id_ue" id="id_ue" value="<%=id_ue%>">
            <div id="col_textCenter">Responsable de aplicar la validación</div>
            <div id="col_inpCenter"><input type="text" name="resp_val" id="resp_val" class="w50">   </div>
            <br><br>
            
            <div id="col_textCenter">Fecha de inicio</div>
            <div id="col_inpCenter"><input type="text" name="fech_ini6" id="fech_ini6" class="fecha w15" placeholder="dd/mm/aaaa"></div>
            <br><br>
            
            <div id="col_textCenter">Fecha de Término</div>
            <div id="col_inpCenter"><input type="text" name="fech_ter6" id="fech_ter6" class="fecha w15" placeholder="dd/mm/aaaa"></div>
            <br><br>
            
            <div id="col_textCenter">¿El archivo está en formato Shape?</div>
            <div id="col_inpCenter">
                <input type="radio" name="f_shape" id="f_shapeSi" value="SI" onclick="javascript:habilita();" ><label for="f_shapeSi">Si</label> &nbsp;  &nbsp;  &nbsp;  &nbsp;  
                <input type="radio" name="f_shape" id="f_shapeNo" value="NO" onclick="javascript:habilita();"><label for="f_shapeNo">No</label>
            </div>
            <br><br>
            
            <div id="col_textCenter">¿El archivo shape contiene las cuatro extensiones mínimas requeridas?<br>(shp, dbf, prj, shx)</div>
            <div id="col_inpCenter">
                <input type="radio" name="extension" id="extensionSi" value="SI" ><label for="extensionSi">Si</label> &nbsp;  &nbsp;  &nbsp;  &nbsp;  
                <input type="radio" name="extension" id="extensionNo" value="NO" ><label for="extensionNo">No</label>
            </div>
            <br><br>
            
            <div id="col_textCenter">¿La estructura del archivo es correcta?</div>
            <div id="col_inpCenter">
               <input type="radio" name="estruc" id="estrucSi" value="SI" ><label for="estrucSi">Si</label> &nbsp;  &nbsp;  &nbsp;  &nbsp;  
               <input type="radio" name="estruc" id="estrucNo" value="NO" ><label for="estrucNo">No</label>
            </div>
            
            <br><br>
            <div id="col_textCenter">Atributos sin valores nulos o vacíos</div>
            <div id="col_inpCenter">
              <input type="radio" name="atrib" id="atribSi" value="SI" ><label for="atribSi">Si</label> &nbsp;  &nbsp;  &nbsp;  &nbsp;  
              <input type="radio" name="atrib" id="atribNo" value="NO" ><label for="atribNo">No</label>  
           </div>
            
            <br><br>
            <div id="col_textCenter">¿La información está en coordenadas geográficas?</div>
            <div id="col_inpCenter">
              <input type="radio" name="coord_geo" id="coord_geoSi" value="SI" ><label for="coord_geoSi">Si</label> &nbsp;  &nbsp;  &nbsp;  &nbsp;  
              <input type="radio" name="coord_geo" id="coord_geoNo" value="NO" ><label for="coord_geoNo">No</label>  
            </div>
            
            <br><br>
            <div id="col_textCenter">Coincide con el total de registros entregados</div>
            <div id="col_inpCenter">
              <input type="radio" name="total_reg" id="total_regSi" value="SI" ><label for="total_regSi">Si</label> &nbsp;  &nbsp;  &nbsp;  &nbsp;  
              <input type="radio" name="total_reg" id="total_regNo" value="NO" ><label for="total_regNo">No</label>  
            </div>
                
                  <div id="btn_enviar">
                      <input type="button" value="Cancelar" name="nuevo_reg" id="nuevo_reg" onclick="javascript:ResetForm6();" class="bLimpiaFrom" >&nbsp; &nbsp; &nbsp; &nbsp;
                     <input type="button" value="+ Agregar Registro" id="agrega_reg" name="agrega_reg" onclick="javascript:proceso_guardaP6();">
                     <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP6();" class="bactualizar">
                 </div>
            <br>
            <div id="btn_enviar">
