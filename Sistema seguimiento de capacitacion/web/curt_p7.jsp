...
<html>
 ...
 String privilegio ="";
    ...
    <head>
        ...
        <script src="js/ajx_guarda_devolucionP7.js" type="text/javascript"></script>
        <script src="js/actualiza_devolucionP7.js" type="text/javascript"></script>
       <!-- <script src="js/funCargaDevoP7.js" type="text/javascript"></script>-->
        
         <script src="js/jquery/recoge_datP6.js" type="text/javascript"></script>
        
        <script>
              $(document).ready(function(){
                    //carga_actualizaP7(< %=id_ue%>);
                    $("#actualizar").css("display","none");
                    carga_resultadosP7(<%=id_ue%>);
                    verifica_permisos(<%=id_ue%>);
                    
                    
            /*     var array2 = []; //creamos un array al cual le agrgaremos los item, mas abajo...
               var param6 = new Object();
                     ...
                     //*agregamos los elementos al array..          
                            ...
                            //document.getElementById("motivos_dev").value = array2; //asignamos el valor a el textarea el resultado del array 
                        }
                        else{  };
    ...
    try{            
     ...
     %>  
        ...
        <div id="cont_formulario">
            <form id="curtp7" name="curtp7">  
            <span class="TextTitulo subrayado">Datos de devolución a la Unidad del Estado</span><br><br>
            ...
            <input type="hidden" name="id_devolucion" id="id_devolucion" value="" > <!-- le agregaremos valor hasta que le demos en el botón editar o Actualizar-->
            
             <div id="col_textCenter">Selecciona el archivo</div>
            <div id="col_inpCenter">
                <select name="id_archivo" id="id_archivo" class="w30" onchange="javascript:carga_datp6(this.value)" >
                ...
                String ID_entrega ="";
           try{     
                PreparedStatement pst28 =(PreparedStatement) conexion.conn.prepareStatement( "SELECT id_entrega, nom_archivo FROM \"seguim_CURT\".criterios_validacion "
                        + "WHERE id_ue ='"+id_ue+"' AND (for_shape = 'NO' OR ext_min= 'NO' OR est_cor = 'NO' OR atrib ='NO' OR info_cord ='NO' OR code_total='NO') ");
            ...
            <div id="col_textCenter">Fecha de la devolución</div>
            <div id="col_inpCenter"><input type="text" name="fech_dev" id="fech_dev" class="fecha w15" placeholder="dd/mm/aaaa"></div>
            <br><br>
            
            <div id="col_textCenter">Motivos de la devolución</div>
            <div id="col_inpCenter"><textarea name="motivos_dev" id="motivos_dev" value="" placeholder="" class="read" rows="3" disabled=""></textarea></div>
            <br><br>
            
            <div id="col_textCenter">Responsable del INEGI de la devolución </div>
                <div id="col_inpCenter"><input type="text" name="resp_dev" id="resp_dev" class="w50"></div>
            <br><br>
            
            <div id="col_textCenter">Responsable de recibir la información en la UE</div>
            <div id="col_inpCenter">
                <input type="text" name="resp_reci" id="resp_reci" class="w50">
            </div>
            <br><br>
            
           <!-- <div id="col_textCenter">Nombre del archivo que se devolvió</div>-->
           <!-- <div id="col_inpCenter">-->
                <input type="hidden" name="arch_dev" id="arch_dev" class="w50">
           <!-- </div>-->
          
            
            <div id="col_textCenter">Total de registros en el archivo devuelto</div>
            <div id="col_inpCenter">
                <input type="" name="total_dev" id="total_dev" class="w15 read" disabled="">
            </div>
                  ...
                  <div id="btn_enviar">
                      ...
                      <input type="button" value="Cancelar" name="nuevo_reg" id="nuevo_reg" onclick="javascript:ResetForm7();" class="bLimpiaFrom" >&nbsp; &nbsp; &nbsp; &nbsp;
                      <input type="button" value="+ Guardar" id="agrega_reg" name="agrega_reg" onclick="javascript:proceso_guardaP7();">
                     <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP7();" class="bactualizar">
                 </div>
