...
String privilegio ="";
    ...
    <head>
        ...
        <script type="text/javascript">
          ...
          <script>
            function ResetFormP8(){
            document.getElementById("curtp8").reset();
              ...
              //$("#nom_arch, #tamano, #no_reg").attr('disabled', false); //lo habilitamos
          }
        </script>
       
        <script src="js/ajx_guarda_infOCP8.js" type="text/javascript"></script>
        <script src="js/actualiza_infOCP8.js" type="text/javascript"></script>
        <script src="js/funCargainfOCP8.js" type="text/javascript"></script>
    ...
    try{             
     ...
     %>  
        ...
        <div id="cont_formulario">
            <form id="curtp8" name="curtp8">  
            <span class="TextTitulo subrayado">Datos de entrega de información a Oficinas Centrales</span><br><br>
         <div id="cont_center"><span class="text_smal15"> <%=nombre_ue+ " ("+Nombre_mun2+", "+name_edo+")"%></span></div><br>
            ...
            <input type="hidden" name="id_eoc" id="id_eoc" value="" >
            <div id="col_textCenter">Fecha</div>
            <div id="col_inpCenter"><input type="text" name="fech_ent" id="fech_ent" class="fecha w15" placeholder="dd/mm/aaaa"></div>
            <br><br>
            
            <div id="col_textCenter">Nombre del responsable de la Unidad Administrativa que entrega </div>
                <div id="col_inpCenter"><input type="text" name="resp_ent" id="resp_ent" class="w50"></div>
            <br><br>
            
            <div id="col_textCenter">Nombre del responsable de Oficinas Centrales que recibe la información</div>
            <div id="col_inpCenter">
                <input type="text" name="respoc_reci" id="respoc_reci" class="w50">
            </div>
                ...
                <div id="btn_enviar">
                    <input type="button" value="Cancelar" name="nuevo_reg" id="nuevo_reg" class="bLimpiaFrom" onclick="javascript:ResetFormP8();" >&nbsp; &nbsp; &nbsp; &nbsp;
                   <input type="button" value="+ Guardar" id="guarda_reg" name="guarda_reg" onclick="javascript:proceso_guardaP8();">
                    <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP8();" class="bactualizar">
                    <br><br>
                    <input type="button" value="&ll; Regresar" onclick="javascript:cancelar_activ();" class="bcancelar">    &nbsp;
                 </div>
            
            <div id="div_delete">
                <!-- <a class="boton_delete" href="javascript:postwith('elimina_registro.jsp',{ue:'< %=id_ue%>', tab:'entrega_oc'})"> 
