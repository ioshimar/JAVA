...
String privilegio ="";
    ...
    <head>
        ...
        <script src="js/ajx_guarda_ssgP9.js" type="text/javascript"></script>
        <script src="js/actualiza_ssgP9.js" type="text/javascript"></script>
        <script src="js/funCargaSSGP9.js" type="text/javascript"></script>
    ...
    try{              
     ...
     %>  
        <div id="cont_formulario">
         ...
         <form id="curtp9" name="curtp9">  
            <span class="TextTitulo subrayado">Datos de entrega a la Subdirección de Soluciones Geomáticas</span><br><br>
            ...
            <div id="col_inpCenter"><input type="text" name="fech_entssg" id="fech_entssg" class="fecha w15" placeholder="dd/mm/aaaa"></div>
            <br><br>
            
            <div id="col_textCenter">Responsable que entrega la información </div>
                <div id="col_inpCenter"><input type="text" name="resp_entssg" id="resp_entssg" class="w50"></div>
            <br><br>
            
            <div id="col_textCenter">Responsable de la Subdirección de Soluciones geomáticas que recibe la información</div>
            <div id="col_inpCenter">
                <input type="text" name="resp_recssg" id="resp_recssg" class="w50">
            </div>
           
                
                  <div id="btn_enviar">
                   <input type="button" value="&ll; Regresar" onclick="javascript:cancelar_activ();" class="bcancelar">    &nbsp;
                    <input type="button" value="+ Guardar" id="guarda_reg" name="guarda_reg" onclick="javascript:proceso_guardaP9();">
                    <input type="button" value="&circlearrowright; Actualizar" name="actualizar" id="actualizar" onclick="javascript:proceso_ActualizaP9();" class="bactualizar">
                 </div>
            
            <div id="div_delete">
               <a class="boton_delete" href="javascript:postwith('elimina_registro.jsp',{ue:'<%=id_ue%>', tab:'entrega_ssg'})"> 
