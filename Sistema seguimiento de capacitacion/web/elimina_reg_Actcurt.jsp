...
<html>
    <head>
     ...
     <% 
         String id_act = request.getParameter("act");
    ...
    <body background="img_codigo4a_roja.jpg"> 
       ...
       <% PreparedStatement pst25 =(PreparedStatement) conexion.conn.prepareStatement( "SELECT * FROM \"seguim_CURT\".actualizacion_curt WHERE id_act = '"+id_act+"'");
        ...
        <div id="cont_form_center">
            ...
            <form action="operacion_elimina_Actcurt.jsp" method="get" id="form-eliminar">
                    <input type="hidden" name="id_act" id="id_act" value="<%=id_act%>">
