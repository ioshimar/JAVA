...
<html>
    ...
    <body background="img_codigo4a_roja.jpg"> 
       ...
       <% PreparedStatement pst25 =(PreparedStatement) conexion.conn.prepareStatement( "SELECT *  FROM \"seguim_CURT\".devolucion WHERE id_dev = '"+id_devolucion+"'");
        ...
        <div id="cont_form_center">
            ...
            <form action="operacion_elimina_devolucion.jsp" method="get" id="form-eliminar">
                    <input type="hidden" name="id_devolucion" id="id_devolucion" value="<%=id_devolucion%>">
