...
<html>
    <head>
        ...
        <script>
            ...
            function EliminaRegistro(){
                ...
                var r = confirm("¿Estás seguro que deseas ELIMINAR el registro? támbien se eliminarán los motivos agregados");
               if (r == true) {
     ...
     <% 
         String id_gen = request.getParameter("generacion");
    ...
    <body background="img_codigo4a_roja.jpg"> 
       ...
       <% PreparedStatement pst25 =(PreparedStatement) conexion.conn.prepareStatement( "SELECT *  FROM \"seguim_CURT\".generacion_curt WHERE id_gen = '"+id_gen+"'");
        ...
        <div id="cont_form_center">
            ...
            <form action="operacion_elimina_gencurt.jsp" method="get" id="form-eliminar">
