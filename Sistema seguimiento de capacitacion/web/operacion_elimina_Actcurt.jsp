...
<html>
    ...
    <body>
         ...
         static String  id_act, id_ue;
         %>
         <%
         ConexionBD conexion=new ConexionBD(); 
    
            id_act = request.getParameter("id_act");
            id_ue = request.getParameter("id_ue");
 
       conexion.stmt=conexion.conn.createStatement();      
       conexion.stmt.executeUpdate( "DELETE FROM \"seguim_CURT\".actualizacion_curt where id_act='"+id_act+"' and id_ue='"+id_ue+"' ");
  ...
  <script>
	alert('Registro eliminado correctamente');
        location.href = "curt_p11.jsp?ue="+<%=id_ue%>; 
