...
String f_inicio_est = request.getParameter("f_inicio_est");
String f_fin_est = request.getParameter("f_fin_est");
//String f_inicio = "2014-06-01";
//String f_fin = "2018-12-31"; 



ResultSet rs1 = Estamento.executeQuery("SELECT count(id_ue) as tot_env FROM \"seguim_CURT\".capacitacion O, \"seguim_CURT\".ufg_directori_ufg C, \"seguim_CURT\".cat_edo D WHERE C.\"Id\" = O.id_ue AND C.\"CVE_ENTIDAD\" = D.\"CVE_EDO\" AND C.\"AMBITO\" LIKE 'E%' AND O.fecha_cap between '"+f_inicio_est+"' and '"+f_fin_est+"';");
...
tot_env = rs1.getString("tot_env");
        ...
        <!--<div id="cont_consulta">-->
            <span class="CarroisGR16">Informe de la instrumentación  de la CURT por Unidad del Estado del <%=f_inicio_est%> al <%=f_fin_est%></span><br><br>
            <div class="r_tit"> CAPACITACIONES (ESTATAL) TOTAL: <%=tot_env%></div> 
            
         <%             


            ResultSet rs = Estamento.executeQuery("SELECT D.\"NOM_EDO\" as nom_ent, \"INSNOMBRECIUDADMPIO\" as municipio, \"INSNOMBRE\" as nom_ue, fecha_cap FROM \"seguim_CURT\".capacitacion O, \"seguim_CURT\".ufg_directori_ufg C, \"seguim_CURT\".cat_edo D WHERE C.\"Id\" = O.id_ue AND C.\"CVE_ENTIDAD\" = D.\"CVE_EDO\" AND C.\"AMBITO\" LIKE 'E%' AND O.fecha_cap between '"+f_inicio_est+"' and '"+f_fin_est+"' ORDER BY D.\"NOM_EDO\" ASC;");
         ...
         <div class="r_tit"> TOTALES </div>            
            ...
            ResultSet rs2 = Estamento.executeQuery("SELECT D.\"NOM_EDO\" as nom_ent, count(O.id_ue) as total FROM \"seguim_CURT\".capacitacion O, \"seguim_CURT\".ufg_directori_ufg C, \"seguim_CURT\".cat_edo D WHERE C.\"Id\" = O.id_ue AND C.\"CVE_ENTIDAD\" = D.\"CVE_EDO\" AND C.\"AMBITO\" LIKE 'E%' AND O.fecha_cap between '"+f_inicio_est+"' and '"+f_fin_est+"' GROUP BY D.\"NOM_EDO\" ORDER BY D.\"NOM_EDO\" ASC;");
         ...
         %>
           ...
           <div id="cur_notas"><a href="exportar_reporte_cap_est.jsp?f_inicio_est=<%=f_inicio_est%>&f_fin_est=<%=f_fin_est%>" target="_new">Descargar archivo</a></div>
