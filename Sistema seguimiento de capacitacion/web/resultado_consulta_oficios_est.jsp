...
String f_inicio_e = request.getParameter("f_inicio_e");
String f_fin_e = request.getParameter("f_fin_e");
//String f_inicio = "2014-06-01";
//String f_fin = "2018-12-31"; 



ResultSet rs1 = Estamento.executeQuery("SELECT count(id_ue) as tot_env FROM \"seguim_CURT\".concertacion O, \"seguim_CURT\".ufg_directori_ufg C WHERE C.\"Id\" = O.id_ue AND C.\"AMBITO\" LIKE 'E%' AND O.fec_pri_env between '"+f_inicio_e+"' and '"+f_fin_e+"';");
...
tot_env = rs1.getString("tot_env");
        ...
        <!--<div id="cont_consulta">-->
            <span class="CarroisGR16">Informe de la instrumentación  de la CURT por Unidad del Estado del <%=f_inicio_e%> al <%=f_fin_e%></span><br><br>
            <div class="r_tit"> OFICIOS ENVIADOS (ESTATAL) TOTAL: <%=tot_env%></div> 
            
         <%             


            ResultSet rs = Estamento.executeQuery("SELECT nom_ent, \"INSNOMBRECIUDADMPIO\" as municipio, \"INSNOMBRE\" as nom_ue FROM \"seguim_CURT\".concertacion O, \"seguim_CURT\".ufg_directori_ufg C WHERE C.\"Id\" = O.id_ue AND C.\"AMBITO\" LIKE 'E%' AND O.fec_pri_env between '"+f_inicio_e+"' and '"+f_fin_e+"' ORDER BY nom_ent ASC;");
 ...
 <%             
            ...
            ResultSet rs2 = Estamento.executeQuery("SELECT nom_ent, count(id_ue) as total FROM \"seguim_CURT\".concertacion O, \"seguim_CURT\".ufg_directori_ufg C WHERE C.\"Id\" = O.id_ue AND C.\"AMBITO\" LIKE 'E%' AND O.fec_pri_env between '"+f_inicio_e+"' and '"+f_fin_e+"' GROUP BY nom_ent ORDER BY nom_ent ASC;");
         ...
         %>
           ...
           <div id="cur_notas"><a href="exportar_reporte_oficios_estatal.jsp?f_inicio_e=<%=f_inicio_e%>&f_fin_e=<%=f_fin_e%>" target="_new">Descargar archivo</a></div>
