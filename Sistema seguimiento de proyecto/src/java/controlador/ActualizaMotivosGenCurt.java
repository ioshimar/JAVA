 ...
 */
public class ActualizaMotivosGenCurt extends HttpServlet {
  ...
  String total_motgen = request.getParameter("total_motgen");
  String mot_gen = request.getParameter("mot_gen");
               ...
               //  out.println(arraySeparadoMuni + "<br/>");
                ...
                try {
                         ...
                         conexion.stmt.executeUpdate("UPDATE \"seguim_CURT\".motivos_gen\n" +
                            "   SET  total_motgen='"+total_motgen+"', mot_gen='"+mot_gen+"', \n" +
                            "   fecha_actualizacion='"+fecha+"'\n" +
                            " WHERE id_motgen = '"+id_motgen+"'");
                    
                   out.print("Registro Actualizado correctamente");
                   response.sendRedirect("motivos_gencurt.jsp?ue="+id_ue+"&gencurt="+id_gen+"&id_entrega="+id_entrega);
