 ...
 */
public class GrabaCurtP1Respaldo extends HttpServlet {
  ...
  /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String nom_edo =new String(request.getParameter("nom_edo").getBytes("ISO-8859-1"),"UTF-8");
        String nombre_muni = new String(request.getParameter("nombre_muni").getBytes("ISO-8859-1"),"UTF-8");
        String cve_edo =request.getParameter("cve_edo");
        String name_ue  = new String(request.getParameter("name_ue").getBytes("ISO-8859-1"),"UTF-8");
    ...
    if(QueaceptoSeparado.equals("ul")){QueaceptoSeparado="";} //es ul porque con el .substring de arriba le quita la primera "n"  la y ultima "l" de null 
        ...
        String motivo  = new String(request.getParameter("motivo").getBytes("ISO-8859-1"),"UTF-8");
        ...
        String nom_destinatario = new String(request.getParameter("nom_destinatario").getBytes("ISO-8859-1"),"UTF-8");
        String nom_remitente = new String(request.getParameter("nom_remitente").getBytes("ISO-8859-1"),"UTF-8");

        String nom_destinatario2 = new String(request.getParameter("nom_destinatario2").getBytes("ISO-8859-1"),"UTF-8");
        String nom_remitente2 = new String(request.getParameter("nom_remitente2").getBytes("ISO-8859-1"),"UTF-8");

        String nom_destinatario3 = new String(request.getParameter("nom_destinatario3").getBytes("ISO-8859-1"),"UTF-8");
        String nom_remitente3 = new String(request.getParameter("nom_remitente3").getBytes("ISO-8859-1"),"UTF-8");
