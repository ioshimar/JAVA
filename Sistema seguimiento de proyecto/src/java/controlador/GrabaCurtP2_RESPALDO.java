 ...
 */
public class GrabaCurtP2_RESPALDO extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        LocalDate fecha_ini = LocalDate.parse(fecha_impart, formato); 
        ...
        conexion.stmt.executeUpdate("SET DATESTYLE TO dmy; INSERT INTO \"seguim_CURT\".capacitacion(\n" +
                    "id_cap, id_ue, fecha_cap, lugar, resp_inegi, cant_pers, fecha_llenado, usuario_resp)\n" +
                    "VALUES (nextval('\"seguim_CURT\".id_capacitacion'),'"+id_ue+"', '"+fecha_ini+"', '"+lugar+"', '"+responsable+"', '"+cantidad_p+"', '"+fecha_llen+"', '"+usuario_resp+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GrabaCurtP2_RESPALDO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
