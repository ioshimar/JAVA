 ...
 */
public class GrabaCurtP3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        conexion.stmt.executeUpdate("SET DATESTYLE TO dmy; INSERT INTO \"seguim_CURT\".registro_ue(\n" +
                "id_reg, id_ue, fec_sol_reg, fec_env_doc, fec_val_doc, fec_env_firm, \n" +
                "fec_regus, fec_rec_doc, fecha_llenado, usuario_resp)\n" +
                "VALUES (nextval('\"seguim_CURT\".id_reg'), '"+id_ue+"', '"+sol_registro+"', '"+envio_doc+"', '"+val_doc+"', '"+fec_firma+"', '"+fec_usu+"', '"+fec_rece+"', '"+fecha_llenado+"', '"+usuario_resp+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GrabaCurtP3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
